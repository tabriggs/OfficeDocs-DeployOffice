---
title: Installing different versions of Office, Project, & Visio on the same computer
ms.author: danbrown
author: DHB-MSFT
manager: laurawi
audience: ITPro
...
|Microsoft 365 Apps  <br/><br/> Project Professional 2019 (volume licensed)  |   Yes, but with a caveat. <sup>2</sup>   | They both use Click-to-Run and are the same version (16.0).         |
| Microsoft 365 Apps  <br/><br/> Visio Standard 2019 (retail) |   Yes, but with a caveat. <sup>2</sup>  | They both use Click-to-Run and are the same version (16.0).         |
